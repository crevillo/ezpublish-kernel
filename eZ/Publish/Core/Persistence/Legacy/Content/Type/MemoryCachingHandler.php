...
class MemoryCachingHandler implements BaseContentTypeHandler
{
    ...
    public function load( $contentTypeId, $status = Type::STATUS_DEFINED )
    {
        if ( isset( $this->contentTypes[$contentTypeId] ) &&
             isset( $this->contentTypes[$contentTypeId][$status] ) )
        {
    ...
    public function loadByIdentifier( $identifier )
    {
        if ( isset( $this->contentTypes['identifier'] ) &&
             isset( $this->contentTypes['identifier'][$identifier] ) )
        {
    ...
    {
        if ( isset( $this->contentTypes['remoteId'] ) &&
             isset( $this->contentTypes['remoteId'][$remoteId] ) )
        {
    ...
    {
        if ( isset( $this->fieldDefinitions[$id] ) &&
             isset( $this->fieldDefinitions[$id][$status] ) )
        {
